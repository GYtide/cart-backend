...
CREATE TABLE `project_data` (
  ...
  `freq` double DEFAULT NULL COMMENT '频率',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='投影预览文件';
...
CREATE TABLE `spec_view` (
  ...
  `date` date DEFAULT NULL COMMENT '日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='频谱概图文件';
...
INSERT INTO project_data(id,file_name,file_path,date,direct,freq) VALUES(3,'CARTImag1DCheck_151MHz_II_EW_20220417.fits','/home/gytide/dsrtprod/data/2023/03/quicklook/CARTImag1DCheck_151MHz_II_EW_20220417.fits','2022-04-17','EW',151),(4,'CARTImag1DCheck_151MHz_II_NS_20220417.fits','/home/gytide/dsrtprod/data/2023/03/quicklook/CARTImag1DCheck_151MHz_II_NS_20220417.fits','2022-04-17','NS',151);
...
INSERT INTO spec_view(id,file_name,file_path,date) VALUES(3,'CARTSpecCheck_II_20220417.fits','/home/gytide/dsrtprod/data/2023/03/quicklook/CARTSpecCheck_II_20220417.fits',NULL);